  ...
  return (
    <div className="surface-panel mb-5 rounded-[0.9rem] p-4 sm:p-5">
      <div className="grid gap-4 lg:grid-cols-[minmax(16rem,1fr)_13rem_13rem_auto] lg:items-end">
        <div className="block">
          <Label htmlFor="deal-search" className="mb-2 block">
            search
          </Label>
        ...
        <div className="block">
          <Label htmlFor="deal-status-filter" className="mb-2 block">
            status
          </Label>
          <Select
          ...
          >
            <SelectTrigger id="deal-status-filter" className="h-12">
        ...
        <div className="block">
          <Label htmlFor="deal-category-filter" className="mb-2 block">
            category
          </Label>
          <Select
          ...
          >
            <SelectTrigger id="deal-category-filter" className="h-12">
